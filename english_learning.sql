...
--
-- Хост: MySQL-8.0
-- Время создания: Май 14 2026 г., 17:11
...
(6, 'Реп екб', 'ekb@rep.ru', '$2y$10$hi4pCvsE2roP/MlNBTipjOmVDToomNsqAsgv5wr0yHFonbC4pvFbq', 'Екатеринбургская Репа Олеговна', 14, 1, '2025-12-07 13:23:09', '2026-05-13 12:16:19', 'tutor', 1, '2026-05-13 12:16:19'),
(8, 'Реп мск', 'msk@rep.ru', '$2y$10$Qal/TQXYozI3akNKwmif9uliOWIGr3sjOSTsXdPFjFJEX/kUyBlZO', 'Московская Репа Ивановна', 1, NULL, '2025-12-07 13:26:49', '2026-05-04 18:12:06', 'tutor', 1, '2026-05-04 18:12:06'),
(9, 'СкуфГерой', 'stud@ekb.ru', '$2y$10$HvYlqQr.R4u.talrwh2g2ejFlOBH1bWcZ3MUIyZuM5dc0XWZkw.r2', 'Иванов Олег Олегович', NULL, 6, '2025-12-08 13:18:18', '2026-04-25 05:22:05', 'student', 1, '2026-04-25 05:22:05'),
...
(15, 'admin', 'adm@adm.ru', '$2y$10$Z5jELBs8bBQZktv.kvQwN.rJL1LBA1mBc1SNbwNh6aIBiOmRnwkyy', 'admin', NULL, 1, '2025-12-10 12:37:48', '2026-04-25 05:33:22', 'admin', 1, '2026-04-25 05:33:22'),
...
(33, 'j', 'sgs@mail.ru', '$2y$10$A9AtMT4YEA7uZmEsHHBVCOyJJgnzN5v1CxpSS7MzRpFKrkS.qteHe', 'jhkj mnhb nh', 3, 1, '2026-04-11 12:07:59', '2026-04-11 12:07:59', 'student', 1, '2026-04-11 12:07:59'),
(34, 'testuser', 'test@mail.ru', '$2y$10$rNiBvEHwYL/iDYt5hTwpmecldXtue3KgYO/PExhxUTy9FaQnyZ.Py', 'Тест', NULL, 1, '2026-04-23 11:57:01', '2026-05-04 19:28:22', 'student', 1, '2026-05-04 19:28:22'),
(35, 'Репетитор тест', 'testrepet@mail.com', '$2y$10$MBLMi2pV/9H7ZbBbjlfFvuD.UAz0MvxUonHlcnKy8ZqvDakH84h1u', 'Маринина Светлана Романовна', NULL, 1, '2026-04-25 18:11:32', '2026-05-13 12:32:59', 'tutor', 1, '2026-05-13 12:32:59'),
...
(38, 'reper', 'reper@mail.com', '$2y$10$O3AVw0KN.g2vqNaeGDdk5uaRJjeuw0x0jKbuvDtKeIchcyBiUSFP.', 'u', NULL, 1, '2026-05-13 12:34:37', '2026-05-13 12:34:37', 'tutor', 1, '2026-05-13 12:34:37');
...
--
ALTER TABLE `achievements`
  MODIFY `achievement_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tutors`
  MODIFY `tutor_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tutor_requests`
  MODIFY `request_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `user_answers`
  MODIFY `answer_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=638;

--
-- AUTO_INCREMENT для таблицы `user_progress`
--
ALTER TABLE `user_progress`
  MODIFY `progress_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
